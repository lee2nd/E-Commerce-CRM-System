Sub DailyA()
    ...
    Dim DaySheetA, ControlPanelSheet, TagSheet, Shopee_sheet As Worksheet
    ...
    With DaySheetA
        ...
        For i = DaySheetALastRow To 2 Step -1
    ...
    With DaySheetA
        ...
        With DaySheetA.Sort
            .SortFields.Clear
            .SortFields.Add Key:=Range("A1:A" & DaySheetALastRow), SortOn:=xlSortOnValues, Order:=xlAscending, DataOption:=xlSortNormal
            .SetRange Range("A1:O" & DaySheetALastRow)
            .Header = xlYes
            .MatchCase = False
